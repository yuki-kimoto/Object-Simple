...
use lib 't/object-simple-old';

BEGIN{ use_ok( 'Object::Simple::Old' ) }
can_ok( 'Object::Simple::Old', qw( new ) ); 
...
isa_ok( $o, 'Object::Simple::Old', "$test : Inherit Object::Simple::Old");
...
{
    my $p = Point->new;
    is_deeply($p, {x => 1, y => 1, p => $Object::Simple::Old::CLASS_INFOS->{Point}{accessors}{p}{options}{default}->()}, 'default overwrited' );
    cmp_ok(ref $Object::Simple::Old::CLASS_INFOS->{Point}{accessors}{p}{options}{default}, 'ne', $p->p, 'default different ref' );
}
...
{
    eval{Object::Simple::Old->build_class({no => 1})};
...
ok($Object::Simple::Old::CLASS_INFOS->{T3_03}{constructor}, 'cache constructor');
$o = T3_03->new(m4 => 4);
is_deeply($o, {m1 => 1, m2 => 2, m3 => 3, m4 => 4, title => 1}, 'use base');
