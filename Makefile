# This Makefile is for the Object::Simple extension to perl.
#
...
#     EXE_FILES => []
#     INSTALLDIRS => q[site]
#     NAME => q[Object::Simple]
#     PREREQ_PM => { Test::More=>q[0] }
#     VERSION_FROM => q[lib/Object/Simple.pm]
...
TO_INST_PM = lib/Object/Simple.pm

PM_TO_BLIB = lib/Object/Simple.pm \
...
DISTNAME = Object-Simple
DISTVNAME = Object-Simple-3.0606
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Object/Simple.pm $(INST_MAN3DIR)/Object::Simple.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:               Object-Simple' >> META_new.yml
	$(NOECHO) $(ECHO) 'version:            3.0606' >> META_new.yml
...
ppd :
	$(NOECHO) $(ECHO) '<SOFTPKG NAME="$(DISTNAME)" VERSION="3,0606,0,0">' > $(DISTNAME).ppd
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' -- \
	  lib/Object/Simple.pm blib/lib/Object/Simple.pm 
