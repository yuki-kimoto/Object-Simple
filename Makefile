...
TO_INST_PM = lib/Simo.BAK \
	lib/Simo.pm \
	lib/Simo/Manual.pod \
	lib/Simo/Manual/Japanese.pod

PM_TO_BLIB = lib/Simo/Manual/Japanese.pod \
	blib/lib/Simo/Manual/Japanese.pod \
	lib/Simo.pm \
	blib/lib/Simo.pm \
	lib/Simo/Manual.pod \
	blib/lib/Simo/Manual.pod \
	lib/Simo.BAK \
	blib/lib/Simo.BAK
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Simo/Manual/Japanese.pod $(INST_MAN3DIR)/Simo::Manual::Japanese.$(MAN3EXT) \
	  lib/Simo.pm $(INST_MAN3DIR)/Simo.$(MAN3EXT) \
	  lib/Simo/Manual.pod $(INST_MAN3DIR)/Simo::Manual.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'version:            0.0801' >> META_new.yml
...
ppd :
	$(NOECHO) $(ECHO) '<SOFTPKG NAME="$(DISTNAME)" VERSION="0,0801,0,0">' > $(DISTNAME).ppd
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' -- \
	  lib/Simo/Manual/Japanese.pod blib/lib/Simo/Manual/Japanese.pod \
	  lib/Simo.pm blib/lib/Simo.pm \
	  lib/Simo/Manual.pod blib/lib/Simo/Manual.pod \
	  lib/Simo.BAK blib/lib/Simo.BAK 
